...
\section{Introduktion}
	...
	Simuleringar av olika naturliga fenomen är ett växande område inom många olika grenar, till exempel vetenskaplig forskning, spelutveckling och specialeffekter i film. Vi fann simulering av hur fluider beter sig instressant, och målet med projektet blev därav att utveckla en interaktiv mjukvara som simulerar fluider i 3D.
