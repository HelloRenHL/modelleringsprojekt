...
This report is the result of a course in modelling and simulation taken at Linköping University, campus Norrköping, during spring 2011. When deciding what subject to model, the authors of this project quickly found that the simulation of fluids would be an exciting and important region to explore.
